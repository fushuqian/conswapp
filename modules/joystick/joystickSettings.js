export class JoystickSettings {
    static SETTINGS = Object.freeze([
        { type: "float", key: 'dzInner',              min: 0.0, max: 0.5,  def: 0.0, label: "死区 内环",                  tip: "Value of desired circular deadzone." },
        { type: "float", key: 'dzOuter',              min: 0.6, max: 1.0,  def: 1.0, label: "死区 外环",                  tip: "Value of the maximum range you want to limit stick output." },
        ...
        { type: "float", key: 'antiDzAngular',        min: 0.0, max: 0.44, def: 0.0, label: "反死区角度",    tip: "Use to counter reticted diagonal movement around the axes based on angle." }, 
        { type: "float", key: 'antiDzOuter',          min: 0.5, max: 1.0,  def: 1.0, label: "反死区外圈",      tip: "Once reached, stick outputs 100%. Useful if user's stick is unable to reach maximum magnitudes." },
        ...
        { type: "float", key: 'diagonalScaleMin',     min: 0.5, max: 1.42, def: 1.0, label: "对角线尺度内圈",     tip: "Use to warp lower magnitude diagonal values." }, 
        { type: "float", key: 'diagonalScaleMax',     min: 0.5, max: 1.42, def: 1.0, label: "对角线尺度外圈",     tip: "Use to warp higher magnitude diagonal values." }, 
